...
(function () {
  // ── styles ─────────────────────────────────────────────
  var css = ''
    + '#colophon .site-info{position:relative;min-height:30px;}'
    + '#banana-ctrl{position:absolute;left:50%;top:50%;'
    +   'transform:translate(-50%,-50%);display:flex;align-items:center;gap:8px;margin:0;'
    +   "font-family:'Source Sans 3',sans-serif;color:#6f5a24;user-select:none;"
    +   'opacity:.45;transition:opacity .2s;}'
    + '#banana-ctrl:hover{opacity:1;}'
    + '#banana-ctrl .bn-track{position:relative;width:110px;height:5px;'
    +   'border-radius:3px;background:rgba(74,58,32,.22);cursor:pointer;}'
    + '#banana-ctrl .bn-fill{position:absolute;left:0;top:0;bottom:0;'
    +   'border-radius:3px;background:rgba(74,58,32,.42);}'
